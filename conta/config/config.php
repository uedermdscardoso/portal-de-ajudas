        ...
        <div class="row">
            ...
            <div class="col-12 col-md-2 col-sm-12" style="padding-top:2.5em;">
                ...
                <ul class="nav flex-column text-center">
                    ...
                    <a href="perfil.php" id="dados_pessoais">
                    ...
                    <!--  
                    <li style="margin-top:2em;"><hr />
                        <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#excluirConta" style="width:100%;">Excluir Conta</button>
                    </li>
                    -->
                </ul>
            ...
            <div class="col-12 col-md-8 col-sm-12 border" id="conteudo-config" style="padding:2.5em;">
                ...
                <div class="row">
                    <div class="col-12 col-md-4 offset-md-4 col-sm-12" style="padding:0em;">
